...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#ccc9c6] shadow-md sticky top-0 z-50">
      <div className="container mx-auto flex items-center justify-between px-4 py-3">
        <div className="flex items-center  gap-16">
          ...
          <ul className="hidden md:flex space-x-8 text-gray-700  font-medium">
            <li>
              <Link href="/solutions" className=" transition">
                Solutions
              </Link>
            </li>
            <li>
              <Link href="/roles" className=" transition">
                Roles
              </Link>
            </li>
            <li>
              <Link href="/resources" className=" transition">
                Resources
              </Link>
            </li>
            <li>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden bg-gray-400 border-t border-gray-200 dark:border-gray-700">
          <ul className="flex flex-col space-y-4 py-4 px-6 text-gray-700  ">
            <li>
              <Link href="/solutions" onClick={toggleMenu}>
                Solutions
              </Link>
            </li>
            <li>
              <Link href="/roles" onClick={toggleMenu}>
                Roles
              </Link>
            </li>
            <li>
          ...
          <div className="flex flex-col space-y-3 px-6 pb-6">
            <button className="text-gray-800   ">Sign in</button>
            <button className="px-4 py-2 border border-gray-800  rounded-lg hover:bg-gray-300 hover:text-black transition">
              Get Demo
            </button>
            <button className="px-4 py-2 bg-yellow-300 text-black rounded-lg font-semibold hover:bg-gray-300 transition">
              Sign up free
